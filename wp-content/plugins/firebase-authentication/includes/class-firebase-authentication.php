...
class MO_Firebase_Authentication {
	...
	public function __construct() {
		if ( defined( 'FIREBASE_AUTHENTICATION_VERSION' ) ) {
			$this->version = FIREBASE_AUTHENTICATION_VERSION;
		} else {
			$this->version = '1.0.0';
		}
	...
	function miniorange_firebase_menu() {
		...
		$page = add_menu_page("Configuration", "Firebase Authentication","manage_options", "mo_firebase_configuration",array($this, 'mo_firebase_auth_options') ,plugin_dir_url(__FILE__) . '../public/images/miniorange.png' );
	}
